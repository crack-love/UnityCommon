...
namespace Common
{
    ...
    public class HelpSelfAttribute : PropertyAttribute
    {
        /// <summary>
        ...
        public HelpSelfAttribute(string text, MessageType type = MessageType.None)
        {
            Text = text;
            Type = type;
        }
...
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(HelpSelfAttribute))]
    class InspectorHelpSelfAttributeDrawer : PropertyDrawer
    {
        ...
        /// </summary>
        public HelpSelfAttribute Attribute => (HelpSelfAttribute)attribute;
