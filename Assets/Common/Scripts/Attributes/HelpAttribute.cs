...
namespace Common
{
    ...
    public class HelpAttribute : PropertyAttribute
    {
        ...
        public HelpAttribute(string text, HelpAttPos pos = HelpAttPos.Below, MessageType type = MessageType.None)
        {
            Text = text;
            Pos = pos;
            Type = type;
    ...
    class HelpAttributeDrawer : PropertyDrawer
    {
        ...
        /// </summary>
        public HelpAttribute Attribute => (HelpAttribute)attribute;
        ...
        public override void OnGUI(Rect position, SerializedProperty prop, GUIContent label)
        {
            ...
            if (helpAttribute.Pos == HelpAttPos.Below)
            {
